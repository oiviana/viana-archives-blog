...
function Flag({ category, foreground, background }: FlagProps) {
  return (
    <span
      className="category-flag flex justify-center items-center min-w-20 text-sm lg:text-base font-jetbrains py-1 px-2 lg:px-3 rounded-xl border"
      style={{ color: foreground, borderColor: foreground, background }}
    >
      {category}
    </span>
  )
